...
class Genre(models.Model):
     ...
     class Meta:
          constraints = [
               UniqueConstraint(Lower("name"), name='genre_name_case_insensitive_unique', violation_error_message= "Genre already exists (Case insenstive match )"),
          ]
...
class Book(models.Model):
    ...
    # call the Genre straigth so we this code to make it callable.
